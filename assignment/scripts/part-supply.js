...
console.log('4. Remove the last value from supplyChanges:', supplyChanges);
...
//    parts in total, and each box holds 7 parts.   // ...each box can hold... (b etter verb tense choice)
...
console.log('9. Boxes filled, containing 7 parts each:', boxesFilled);
console.log('9. Quantity of leftover parts remaining:', parts);
